...
public:
	...
	virtual void ANIM_CreateAnimFrame(const idRenderModel *model, const idMD5Anim *anim, int numJoints, idJointMat *frame, float time, const idVec3 &offset, bool remove_origin_offset);
