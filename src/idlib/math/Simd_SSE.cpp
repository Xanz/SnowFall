...
#define TRANSPOSE_4x4(reg0, reg1, reg2, reg3, reg4)               \
	__asm movaps reg4, reg2 /* reg4 =  8,  9, 10, 11 */           \
		...
		reg0 /* reg1 =  0,  4,  1,  5 */                          \
		__asm shufps reg0,                                        \
		reg2, R_SHUFFLEPS(0, 1, 0, 1) /* reg0 =  0,  4,  8, 12 */ \
		__asm shufps reg1,                                        \
		reg2, R_SHUFFLEPS(2, 3, 2, 3) /* reg1 =  1,  5,  9, 13 */ \
		__asm movaps reg2,                                        \
		reg3 /* reg2 =  2,  6,  3,  7 */                          \
		__asm shufps reg2,                                        \
		reg4, R_SHUFFLEPS(0, 1, 0, 1) /* reg2 =  2,  6, 10, 14 */ \
		__asm shufps reg3,                                        \
...
#define TRANPOSE_4x4_FROM_MEMORY(address, reg0, reg1, reg2, reg3, reg4) \
	__asm movlps reg1, [address + 0] /* reg1 =  0,  1,  X,  X */        \
		...
		reg1 /* reg0 =  0,  1,  4,  5 */                                \
		__asm shufps reg0,                                              \
		reg2, R_SHUFFLEPS(0, 2, 0, 2) /* reg0 =  0,  4,  8, 12 */       \
		__asm shufps reg1,                                              \
		reg2, R_SHUFFLEPS(1, 3, 1, 3) /* reg1 =  1,  5,  9, 13 */       \
		__asm movaps reg2,                                              \
		reg3 /* reg2 =  2,  3,  6,  7 */                                \
		__asm shufps reg2,                                              \
		reg4, R_SHUFFLEPS(0, 2, 0, 2) /* reg2 =  2,  6, 10, 14 */       \
		__asm shufps reg3,                                              \
...
#define TRANSPOSE_4x3(reg0, reg1, reg2, reg3)                     \
	__asm movaps reg3, reg2 /* reg3 =  8,  9, 10, 11 */           \
		__asm shufps reg3,                                        \
		reg1, R_SHUFFLEPS(2, 3, 0, 1) /* reg3 = 10, 11,  4,  5 */ \
		__asm shufps reg2,                                        \
		reg0, R_SHUFFLEPS(0, 1, 2, 3) /* reg2 =  8,  9,  2,  3 */ \
		__asm shufps reg1,                                        \
		reg0, R_SHUFFLEPS(2, 3, 0, 1) /* reg1 =  6,  7,  0,  1 */ \
		__asm movaps reg0,                                        \
		reg1 /* reg0 =  6,  7,  0,  1 */                          \
		__asm shufps reg0,                                        \
		reg2, R_SHUFFLEPS(2, 0, 3, 1) /* reg0 =  0,  6,  3,  9 */ \
		__asm shufps reg1,                                        \
		reg3, R_SHUFFLEPS(3, 1, 2, 0) /* reg1 =  1,  7,  4, 10 */ \
		__asm shufps reg2,                                        \
...
#define TRANSPOSE_4x3_FROM_MEMORY(address, reg0, reg1, reg2, reg3) \
	__asm movlps reg1, [address + 0] /* reg1 =  0,  1,  X,  X */   \
		...
		reg1 /* reg0 =  0,  1,  6,  7 */                           \
		__asm shufps reg0,                                         \
		reg2, R_SHUFFLEPS(0, 2, 1, 3) /* reg0 =  0,  6,  3,  9 */  \
		__asm shufps reg1,                                         \
		reg3, R_SHUFFLEPS(1, 3, 0, 2) /* reg1 =  1,  7,  4, 10 */  \
		__asm shufps reg2,                                         \
...
#define KF2IDS4(SRC0) \
	__asm movups xmm2, SRC0 __asm cvttps2pi mm2, xmm2 __asm movq[edi + ebx + 0], mm2 __asm shufps xmm2, xmm2, SHUFFLEPS(1, 0, 3, 2) __asm cvttps2pi mm2, xmm2 __asm movq[edi + ebx + 8], mm2
...
#define SINGLE_OP(SRC, DEST) \
	__asm movlps xmm0, [SRC] __asm movlps xmm1, [SRC + 8] __asm mulps xmm0, xmm4 __asm mulps xmm1, xmm5 __asm addps xmm0, xmm1 __asm movaps xmm1, xmm0 __asm shufps xmm1, xmm1, SHUFFLEPS(1, 1, 1, 1) __asm addss xmm0, xmm1 __asm movss[DEST], xmm0 __asm add SRC, 16 __asm add DEST, 4
...
#define MUL_Nx3_3x6_FIRST4COLUMNS_ROW(row) \
	__asm movss xmm3, [edi + (row * 3 + 0) * 4] __asm shufps xmm3, xmm3, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm3, xmm0 __asm movss xmm4, [edi + (row * 3 + 1) * 4] __asm shufps xmm4, xmm4, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm4, xmm1 __asm addps xmm3, xmm4 __asm movss xmm5, [edi + (row * 3 + 2) * 4] __asm shufps xmm5, xmm5, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm5, xmm2 __asm addps xmm3, xmm5 __asm movlps[eax + (row * 6 + 0) * 4], xmm3 __asm movhps[eax + (row * 6 + 2) * 4], xmm3
...
#define MUL_Nx6_6x4_ROW(row) \
	__asm movss xmm7, [edi + row * 24 + 0] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7, xmm0 __asm movss xmm6, [edi + row * 24 + 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 8] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 12] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 16] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + row * 24 + 20] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movaps[eax + row * 16], xmm7
...
#define MUL_2xN_2x2_INIT \
	__asm mov esi, m2Ptr __asm mov edi, m1Ptr __asm mov eax, dstPtr __asm movlps xmm0, [esi] __asm shufps xmm0, xmm0, R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm1, [esi + 8] __asm shufps xmm1, xmm1, R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_2xN_2x2_ROW2(N, row) \
	__asm movlps xmm6, [edi + (row + 0 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm movlps xmm7, [edi + (row + 1 * N) * 4] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm0 __asm mulps xmm7, xmm1 __asm addps xmm6, xmm7 __asm movaps[eax + (row * 2) * 4], xmm6
...
#define MUL_4xN_4x4_ROW(N, row) \
	__asm movss xmm7, [edi + (row + 0 * N) * 4] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7, xmm0 __asm movss xmm6, [edi + (row + 1 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + (row + 2 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + (row + 3 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, xmm6 __asm movaps[eax + row * 16], xmm7
...
#define MUL_6xN_6x6_LAST2COLUMNS_INIT \
	__asm movlps xmm0, [esi + 4 * 4] __asm movlps xmm1, [esi + 10 * 4] __asm shufps xmm0, xmm0, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm1, xmm1, R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm2, [esi + 16 * 4] __asm movlps xmm3, [esi + 22 * 4] __asm shufps xmm2, xmm2, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm3, xmm3, R_SHUFFLEPS(0, 1, 0, 1) __asm movlps xmm4, [esi + 28 * 4] __asm movlps xmm5, [esi + 34 * 4] __asm shufps xmm4, xmm4, R_SHUFFLEPS(0, 1, 0, 1) __asm shufps xmm5, xmm5, R_SHUFFLEPS(0, 1, 0, 1)

#define MUL_6xN_6x6_LAST2COLUMNS_ROW2(N, row) \
	__asm movlps xmm7, [edi + (row * 2 + 0 * N) * 4] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm7, xmm0 __asm movlps xmm6, [edi + (row * 2 + 1 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm1 __asm addps xmm7, xmm6 __asm movlps xmm6, [edi + (row * 2 + 2 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm2 __asm addps xmm7, xmm6 __asm movlps xmm6, [edi + (row * 2 + 3 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm3 __asm addps xmm7, xmm6 __asm movlps xmm6, [edi + (row * 2 + 4 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm4 __asm addps xmm7, xmm6 __asm movlps xmm6, [edi + (row * 2 + 5 * N) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 1, 1) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movlps[eax + (row * 12 + 4) * 4], xmm7 __asm movhps[eax + (row * 12 + 10) * 4], xmm7

#define MUL_6xN_6x6_LAST2COLUMNS_ROW(N, row) \
	__asm movss xmm7, [edi + (1 * N - 1) * 4] __asm shufps xmm7, xmm7, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm7, xmm0 __asm movss xmm6, [edi + (2 * N - 1) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm1 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + (3 * N - 1) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm2 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + (4 * N - 1) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm3 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + (5 * N - 1) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm4 __asm addps xmm7, xmm6 __asm movss xmm6, [edi + (6 * N - 1) * 4] __asm shufps xmm6, xmm6, R_SHUFFLEPS(0, 0, 0, 0) __asm mulps xmm6, xmm5 __asm addps xmm7, xmm6 __asm movlps[eax + (row * 6 + 4) * 4], xmm7
