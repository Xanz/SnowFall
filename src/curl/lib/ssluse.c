...
static bool seed_enough(int nread)
{
...
static int random_the_seed(struct SessionHandle *data)
{
...
#define RANDOM_FILE "" /* doesn't matter won't be used */
#endif
  {
    ...
    nread += RAND_load_file((data->set.ssl.random_file ? data->set.ssl.random_file : RANDOM_FILE),
                            16384);
